...
export default {
    ...
    contactForm: {
        ...
        consent: companyConsent !== "%COMPANY_CONSENT%" ? companyConsent : `By submitting this form and signing up for texts, you consent to receive recurring text messages from "${companyName}" at the number provided, including appointment reminders and office updates. Message frequency may vary. Reply HELP for help, STOP to cancel. Consent is not a condition of care. Msg & data rates may apply.`,
